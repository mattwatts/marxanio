output$sidebarui <- renderUI({
    sidebarPanel(
        ...
        #h5("Notes"),
        #br(),
        HTML("<a href='mailto:mattejwatts@gmail.com?subject=marxanio'>Contact the web master</a>")#,
        #br(),
        #br(),
        #HTML("Do not press 'Run' again until your runs finish. This overloads the system for all users.")
    ) # sidebarPanel
}) # renderUI
