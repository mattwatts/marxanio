...
safe_file_copy <- function(sSource,sDestination)
{
    fResult <- file.copy(sSource,sDestination)

    #AppendLogFile(sLogFile,paste0("input$acceptupload safe_file_copy result>",fResult,"< source>",sSource,"< destination>",sDestination,"<"))
}
...
AddDatabase <- function(sDatabase)
{
    ...
    if (fMarZone)
    {
        ...
        safe_file_copy(paste0(sUserSession,"/marzone/input/bound.dat"),paste0(sDatabase,"/input/bound.dat"))
        safe_file_copy(paste0(sUserSession,"/marzone/input/pu.dat"),paste0(sDatabase,"/input/pu.dat"))
        safe_file_copy(paste0(sUserSession,"/marzone/input/puorder.dat"),paste0(sDatabase,"/input/puorder.dat"))
        safe_file_copy(paste0(sUserSession,"/marzone/input/spec.dat"),paste0(sDatabase,"/input/spec.dat"))
        safe_file_copy(paste0(sUserSession,"/marzone/input/sporder.dat"),paste0(sDatabase,"/input/sporder.dat"))
		# copy the MarZone input files
		safe_file_copy(paste0(sUserSession,"/marzone/input/zoneboundcost.dat"),paste0(sDatabase,"/input/zoneboundcost.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonecontrib.dat"),paste0(sDatabase,"/input/zonecontrib.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonecontrib2.dat"),paste0(sDatabase,"/input/zonecontrib2.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonecontrib3.dat"),paste0(sDatabase,"/input/zonecontrib3.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonetarget.dat"),paste0(sDatabase,"/input/zonetarget.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonetarget2.dat"),paste0(sDatabase,"/input/zonetarget2.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/pulock.dat"),paste0(sDatabase,"/input/pulock.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/puzone.dat"),paste0(sDatabase,"/input/puzone.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zones.dat"),paste0(sDatabase,"/input/zones.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/costs.dat"),paste0(sDatabase,"/input/costs.dat"))
		safe_file_copy(paste0(sUserSession,"/marzone/input/zonecost.dat"),paste0(sDatabase,"/input/zonecost.dat"))
        # copy the pulayer files
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/leaflet.Rdata"),paste0(sDatabase,"/pulayer/leaflet.Rdata"))
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/pulayer.dbf"),paste0(sDatabase,"/pulayer/pulayer.dbf"))
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/pulayer.prj"),paste0(sDatabase,"/pulayer/pulayer.prj"))
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/pulayer.Rdata"),paste0(sDatabase,"/pulayer/pulayer.Rdata"))
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/pulayer.shp"),paste0(sDatabase,"/pulayer/pulayer.shp"))
        safe_file_copy(paste0(sUserSession,"/marzone/pulayer/pulayer.shx"),paste0(sDatabase,"/pulayer/pulayer.shx"))
    } else {
    }
        safe_file_copy(paste0(sUserSession,"/marxan/input.dat"),paste0(sDatabase,"/input.dat"))
        #system(paste0("cp ",sUserSession,"/marxan/input/* ",sDatabase,"/input/"))
        #system(paste0("cp ",sUserSession,"/marxan/pulayer/* ",sDatabase,"/pulayer/"))
		# copy the input files
        safe_file_copy(paste0(sUserSession,"/marxan/input/bound.dat"),paste0(sDatabase,"/input/bound.dat"))
        safe_file_copy(paste0(sUserSession,"/marxan/input/pu.dat"),paste0(sDatabase,"/input/pu.dat"))
        safe_file_copy(paste0(sUserSession,"/marxan/input/puorder.dat"),paste0(sDatabase,"/input/puorder.dat"))
        safe_file_copy(paste0(sUserSession,"/marxan/input/spec.dat"),paste0(sDatabase,"/input/spec.dat"))
        safe_file_copy(paste0(sUserSession,"/marxan/input/sporder.dat"),paste0(sDatabase,"/input/sporder.dat"))
        # copy the pulayer files
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/leaflet.Rdata"),paste0(sDatabase,"/pulayer/leaflet.Rdata"))
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/pulayer.dbf"),paste0(sDatabase,"/pulayer/pulayer.dbf"))
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/pulayer.prj"),paste0(sDatabase,"/pulayer/pulayer.prj"))
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/pulayer.Rdata"),paste0(sDatabase,"/pulayer/pulayer.Rdata"))
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/pulayer.shp"),paste0(sDatabase,"/pulayer/pulayer.shp"))
        safe_file_copy(paste0(sUserSession,"/marxan/pulayer/pulayer.shx"),paste0(sDatabase,"/pulayer/pulayer.shx"))
}
