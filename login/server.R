    ...
    observe({
        ...
        output$sidebarui <- renderUI({
          ...
          sidebarPanel(
              ...
              br(),
              br(),
              a("Run Marxan", href=paste0("http://",sAppServer,"/rshiny/apps/",sUserName,"/revision46/marxan/?session=",sUserSessionKey), target="_blank"),
              br(),
              br(),
              ...
              br(),
              br(),
              a("Manage a dataset", href=paste0("http://",sAppServer,"/rshiny/apps/",sUserName,"/revision46/manage/?session=",sUserSessionKey), target="_blank"),
              br()
          ) # sidebarPanel
          }
        }) # renderUI
