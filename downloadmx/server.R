...
append_log_table <- function(fAll)
{
    ...
    if (!fAll)
    {
        ...
        sLine <- paste(sDate,sUserSessionKey,sFingerprint,sUserIP,sUserHostname,dQuote(sName),dQuote(sOrganisation),
                       dQuote(sCountry),sEmail,sSubscribe,sRegisterIO,dQuote(sIndustry),dQuote(sResearchInterest),sep=",")
        ...
        sLine <- paste(sDate,sUserSessionKey,sFingerprint,sUserIP,sUserHostname,dQuote(sName),dQuote(sOrganisation),
                       dQuote(sCountry),sEmail,sSubscribe,sRegisterIO,dQuote(sIndustry),dQuote(sResearchInterest),"mx",sep=",")
        write(sLine,file=sLogTable,append=TRUE)
