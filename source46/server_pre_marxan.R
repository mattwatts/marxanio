...
{
    AppendLogFile(sLogFile,"AddDatabase start")
    ...
    AppendLogFile(sLogFile,"AddDatabase end")
}
...
return_mv_table <- function(iTable)
{
    ...
    cat(paste0("return_mv_table c fZoneTarget ",fZoneTarget," fZoneTarget2 ",fZoneTarget2," dim(thetable) ",dim(thetable),"\n"))
    ...
    cat(paste0("return_mv_table end dim(thetable) ",dim(thetable),"\n"))
